# add a picture to snake's head
# add a logic that allows the picture to rotate with the snake
# add a sound that denotes that the rotation has happened
...
head_square = [100, 100]
head_picture= pygame.image.load('lab9/head.png')
default_image_size=(10,10)
head_picture=pygame.transform.scale(head_picture,default_image_size)
...
rotation_sound = pygame.mixer.Sound("lab9\crash.wav")
...
while not done:
    ...
    # Movement logic
    if next_dir == "right" and direction != "left" and direction!="right":
        rotation_sound.play()
        direction = "right"
    if next_dir == "up" and direction != "down" and direction!="up":
        rotation_sound.play()
        direction = "up"
    if next_dir == "left" and direction != "right" and direction!="left":
        rotation_sound.play()
        direction = "left"
    if next_dir == "down" and direction != "up" and direction!="down":
        rotation_sound.play()
        direction = "down"
    ...
    if direction=="left":
        head_picture1=pygame.transform.rotate(head_picture, 180)
    elif direction=="up":
        head_picture1=pygame.transform.rotate(head_picture, 90)
    elif direction=="down":
        head_picture1=pygame.transform.rotate(head_picture, -90)
    else:
        head_picture1=head_picture
    
    screen.blit(head_picture1,(head_square[0],head_square[1]))
